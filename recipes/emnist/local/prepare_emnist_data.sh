...
if [ ! -f "${outdir}/.done" ]; then
    ...
    unzip -p gzip.zip gzip/emnist-letters-train-images-idx3-ubyte.gz | \
        gunzip > "${outdir}/rawdata/emnist-letters-train-images.raw" || exit 1
    unzip -p gzip.zip gzip/emnist-letters-train-labels-idx1-ubyte.gz | \
        gunzip > "${outdir}/rawdata/emnist-letters-train-labels.raw" || exit 1
    unzip -p gzip.zip gzip/emnist-letters-test-images-idx3-ubyte.gz | \
        gunzip > "${outdir}/rawdata/emnist-letters-test-images.raw" || exit 1
    unzip -p gzip.zip gzip/emnist-letters-test-labels-idx1-ubyte.gz | \
    ...
    unzip -p gzip.zip gzip/emnist-digits-train-images-idx3-ubyte.gz | \
        gunzip > "${outdir}/rawdata/emnist-digits-train-images.raw" || exit 1
    unzip -p gzip.zip gzip/emnist-digits-train-labels-idx1-ubyte.gz | \
        gunzip > "${outdir}/rawdata/emnist-digits-train-labels.raw" || exit 1
    unzip -p gzip.zip gzip/emnist-digits-test-images-idx3-ubyte.gz | \
        gunzip > "${outdir}/rawdata/emnist-digits-test-images.raw" || exit 1
    unzip -p gzip.zip gzip/emnist-digits-test-labels-idx1-ubyte.gz | \
    ...
    rm -fr gzip.zip "${outdir}/rawdata" || exit 1
