...
def main():
    ...
    for line in sys.stdin:
        ...
        post_params = model.encoder_problayer1(enc_states)
        samples, _ = model.encoder_problayer1.samples_and_llh(post_params)
        ali = model.latent_model1.decode(samples, inference_graph=graph)
