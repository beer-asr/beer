...
def main():
    ...
    for line in sys.stdin:
        ...
        posterior_params = model.encoder_problayer1(enc_states)
        samples, _ = model.encoder_problayer1.samples_and_llh(posterior_params,
                                                              use_mean=True)
        best_path = model.latent_model1.decode(samples)
