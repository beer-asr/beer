...
def read_langs(filename, reverse=False):
    print("Reading lines...")
...
def prepare_data(filename, reverse=False):
    input_lang, output_lang, pairs = read_langs(filename, reverse)
...
class Attn(nn.Module):
    ...
    def forward(self, hidden, encoder_outputs):
        ...
        attn_energies = torch.zeros(seq_len, device=hidden.device) # B x 1 x S
