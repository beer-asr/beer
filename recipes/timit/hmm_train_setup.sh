...
model_dir="/export/b07/jyang/beer/recipes/timit/exp_feat_transformed_hmm_gmm_1_noise_0"
emiss_conf="/export/b07/jyang/beer/recipes/timit/conf/hmm.yml"
#phonelist="/export/b07/jyang/beer/recipes/timit/data/lang/phones.txt"
#nstate_per_phone=3

feats=$datadir/feats_transformed.npz 
